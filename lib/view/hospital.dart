...
import 'package:collegeprojectmerch/components/loader.dart';
    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
                  ...
                  MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      if (file != null) {
                        ...
                        Functions.showSnackBar('please select image', context);
                      }
                      print(downloadURL);
            ...
            Visibility(visible: setBusy, child: const Loader())
          ],
        ));
  }
